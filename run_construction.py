...
def main():
    ...
    parser.add_argument('skel_filename', nargs='?', help='skeleton filename')
    parser.add_argument('input_folder', nargs='?',  help='folder containing BVH files')
    parser.add_argument('output_folder', nargs='?',  help='folder containing the resulting model')
